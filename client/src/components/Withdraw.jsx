...
const Withdraw = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.put("http://127.0.0.1:8000/withdraw", {
      ...
      setError("Failed to process withdrawal. Please check the account number and amount.");
      setResponse(null);
          ...
          <div className="col-md-6">
            <div className="card shadow-sm bg-dark text-light border-secondary">
              <div className="card-header bg-secondary text-white">
                <h3 className="card-title text-center mb-0">Withdraw Money</h3>
              </div>
